...
: settings_(std::make_shared<TabSettings>()),           // Create settings manager
  ...
  content_box_(Gtk::ORIENTATION_VERTICAL, 15),          // Content container with 15px spacing
  ...
  buttons_box_(Gtk::ORIENTATION_HORIZONTAL, 10)         // Buttons container with 10px spacing
{
    ...
    content_box_.set_margin_start(20);
    content_box_.set_margin_end(20);
    content_box_.set_margin_top(20);
    content_box_.set_margin_bottom(20);
