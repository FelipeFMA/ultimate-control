...
namespace Display
{
          ...
          bluelight_scale_(Gtk::ORIENTATION_HORIZONTAL)            // Horizontal color temperature slider
    {
        ...
        brightness_scale_.add_mark(75, Gtk::POS_BOTTOM, "75%");
        brightness_scale_.add_mark(100, Gtk::POS_BOTTOM, "100%");
        ...
        bluelight_scale_.add_mark(5000, Gtk::POS_BOTTOM, "5000K");
        bluelight_scale_.add_mark(6500, Gtk::POS_BOTTOM, "6500K (Cool)");
