...
namespace Volume
{
    ...
    struct AudioSink
    {
        ...
        bool is_default;         ///< Whether this is the default device for its type
    };
    ...
    public:
         ...
         *
         * Sets the specified audio device as the default for its type (input or output).
         * This affects where new audio streams are directed.
         */
